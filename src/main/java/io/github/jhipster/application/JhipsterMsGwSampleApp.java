...
@EnableZuulProxy
public class JhipsterMsGwSampleApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterMsGwSampleApp.class);

    private final Environment env;

    public JhipsterMsGwSampleApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterMSGwSample.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterMsGwSampleApp.class);
